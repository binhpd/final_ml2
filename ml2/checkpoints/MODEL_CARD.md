...
- **Dummy data**: chỉ cho smoke test, không liên quan production
...
Model **converge từ epoch 48**, sau đó dao động ±0.0010. 80 epoch là quá đủ.
...
#   'enhanced': CLAHE + adaptive threshold scan-like output,
# }

cv2.imwrite('scan_output.jpg', result['enhanced'])
```
